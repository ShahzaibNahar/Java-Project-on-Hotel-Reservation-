...
public class Project {
    public static void main(String[] args){
        System.out.println("Welcome to The Nahar Hotels Online Booking");
        ...
        try
        {
            ...
            do{
                ...
                System.out.println("\nEnter Your Choice :\n1.Display Rooms' Details\n2.Display Rooms' Availability \n3.Book a Room of Your Choice\n4.Hungry? Order Food Now \n5.Checkout From The Hotel\n6.Exit (Close The Program)\n");
                ch = sc.nextInt();
                switch(ch){
                    case 1: System.out.println("\nChoose Room Type You Want :\n1.Luxury Double Room \n2.Deluxe Double Room \n3.Luxury Single Room \n4.Deluxe Single Room\n");
                        ch2 = sc.nextInt();
                        Hotel.features(ch2);
                        break;
...
class Hotel
{
    ...
    static void availability(int i)
    {
        ...
        System.out.println("Number of Rooms Available Are : "+count);
    }

    static void bill(int rn,int rtype)
    {
        double amount=0;
        String list[]={"Dahi Bary","Pasta","Burger","Coke"};
        System.out.println("\n*******");
        ...
        switch(rtype)
        {
            case 1:
                ...
                break;
            case 2:amount+=8000;
                System.out.println("Room Charges - "+8000);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                ...
                break;
            case 3:amount+=6000;
                System.out.println("Room Charges - "+6000);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                ...
                break;
            case 4:amount+=4500;
                System.out.println("Room Charges - "+4500);
                System.out.println("\nFood Charges:- ");
                System.out.println("===============");
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
    ...
    static void order(int rn,int rtype)
    {
        ...
        try{
            ...
            System.out.println("Thank You \nYour Food Will be Delivered to Your Room in 15 Minutes.");
        }
